...
public class LampConnectorBlock extends Block implements Waterloggable {
    ...
    public LampConnectorBlock(DyeColor color, AbstractBlock.Settings properties) {
        super(properties);
        this.color = color;
    ...
    public static Block getLampByColor(DyeColor color) {
        Block var10000;
        switch (color) {
            case WHITE -> var10000 = (Block)AFBlocks.WHITE_LAMP.get();
            case ORANGE -> var10000 = (Block)AFBlocks.ORANGE_LAMP.get();
